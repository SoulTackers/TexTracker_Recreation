...
from Inward.models import Inward, InwardPostType, InwardMode
...
class Feesinward(models.Model):
    ...
    feesinward_inward_mode_id = models.ForeignKey(
        InwardMode, on_delete=models.CASCADE, blank=True, null=True)
    feesinward_employee_id = models.ForeignKey(
